...
REPO_REVISION=9f1b0ef7e9882a034b5504136ea208c8ac6329ea
#REPO_REVISION2=ba623f7f8b93a060c3af54d35fee9b28eeddb1fe
VERSION=0.2.43.0-$(shell date '+%Y%m%d')
...
dist/AirConnect-${ARCH}-${VERSION}.spk: target/package.tgz target/scripts target/WIZARD_UIFILES target/LICENSE target/INFO target/PACKAGE_ICON.PNG dist
...
ppc:
	...
	$(eval export INFO_FIRMWARE=4.2-3211)
	@true
...
.PHONY: shellcheck
shellcheck:
	shellcheck -s sh scripts/* build.sh
